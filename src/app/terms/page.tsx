    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        ...
        <p className={styles.subtitle}>
          Legal parameters and deployment constraints for utilizing the aviatorIQ prediction engines. Binding agreement automatically executed upon connection payload.
        </p>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.paragraph}>
             Due to the chaotic nature of the target server&apos;s RNG hashing algorithms, the aviatorIQ engine is designed for edge probability generation, not absolute certainty. Operators assume total mechanical liability regarding their equity allocation and automated bet execution configurations.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>Do not route aviatorIQ telemetry directly into public Discord/Telegram channels without explicit Enterprise broadcast licensing.</li>
          </ul>
        </section>
